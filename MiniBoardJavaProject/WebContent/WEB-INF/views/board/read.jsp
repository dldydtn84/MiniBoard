...
<script
	src="https://ajazx.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script
					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="text-right">
								...
								<c:if
									test="${loginUserBean.user_idx == contentBean.content_writer_idx }">
									<a
